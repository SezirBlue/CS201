...
//this will be passed around so that the data can be edited, and statistics recorded
...
//funciton prototypes
stringWithCount findAndReplace(string find, string replace, string text); //uses getline to find and replace in a line of text
int findInStr(string text, string find); //get location of the string to find in the text
stringWithCount procesFile(ifstream & fin, string find, string replace); // run find and replace on each line in the program
string getfind();//get string to find
string getreplace();//get string to insert in place
string getfile(); //get file to open
